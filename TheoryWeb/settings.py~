...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'files/css')
...
SECRET_KEY = '36i4-f(b*lvmh5d8o0ea86yu%se8%gu2y6084ik-t-wn3yzoki'
...
ROOT_URLCONF = 'TheoryWeb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TheoryWeb.wsgi.application'

TEMPLATE_DIRS = (
    os.path.join(PROJECT_DIR, "files/templates"),
    # Don't forget to use absolute paths, not relative paths.
)
