Ember.TEMPLATES['about'] =  Ember.HTMLBars.template((function() {
  return {
    ...
    build: function build(dom) {
      ...
      dom.setAttribute(el8,"class","glyphicon glyphicon-send");
      dom.appendChild(el7, el8);
      var el8 = dom.createTextNode("\n                        ");
      dom.appendChild(el7, el8);
      dom.appendChild(el6, el7);
...
Ember.TEMPLATES['addpost'] =  Ember.HTMLBars.template((function() {
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      element(env, element3, context, "action", ["createNew"], {});
      element(env, element4, context, "action", ["createNewAndContinue"], {});
      return fragment;
    }
  };
}()));
Ember.TEMPLATES['addproject'] =  Ember.HTMLBars.template((function() {
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element3 = dom.childAt(element0, [29]);
      var element4 = dom.childAt(element0, [31]);
      var morph0 = dom.createMorphAt(element0,3,3);
      var morph1 = dom.createMorphAt(element0,7,7);
      var morph2 = dom.createMorphAt(dom.childAt(element0, [17]),1,1);
      var morph3 = dom.createMorphAt(element0,21,21);
      var morph4 = dom.createMorphAt(dom.childAt(element0, [25]),1,1);
      ...
      element(env, element1, context, "bind-attr", [], {"src": get(env, context, "model.image")});
      inline(env, morph2, context, "textarea", [], {"class": "form-control", "placeholder": "Post Body", "value": get(env, context, "model.description"), "rows": "10"});
      inline(env, morph3, context, "input", [], {"class": "form-control", "value": get(env, context, "model.project_link")});
      inline(env, morph4, context, "input", [], {"class": "form-control", "value": get(env, context, "model.code_link")});
      element(env, element2, context, "action", ["cancel"], {});
      element(env, element3, context, "action", ["createNew"], {});
      element(env, element4, context, "action", ["createNewAndContinue"], {});
      return fragment;
...
Ember.TEMPLATES['blog'] =  Ember.HTMLBars.template((function() {
    ...
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          element(env, element9, context, "action", ["cancelState"], {});
          element(env, element10, context, "action", ["saveEdits"], {});
          return fragment;
        }
      };
    }());
    var child1 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          element(env, element8, context, "action", ["editState"], {});
    ...
    var child0 = (function() {
      var child0 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            element(env, element5, context, "action", ["cancelDelete", get(env, context, "post")], {});
            element(env, element6, context, "action", ["confirmDelete", get(env, context, "post")], {});
            return fragment;
          }
        };
      }());
      var child1 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            element(env, element4, context, "action", ["deleteModel", get(env, context, "post")], {});
            return fragment;
          }
        };
      }());
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph4 = dom.createMorphAt(fragment,25,25,contextualElement);
          ...
          inline(env, morph3, context, "textarea", [], {"class": "form-control", "value": get(env, context, "post.post_body"), "rows": "15"});
          block(env, morph4, context, "if", [get(env, context, "post.enableDelete")], {}, child0, child1);
          return fragment;
        }
      };
    }());
    var child1 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          inline(env, morph2, context, "date-format", [get(env, context, "post.created_at")], {});
          element(env, element3, context, "bind-attr", [], {"src": get(env, context, "post.image")});
  ...
  var child2 = (function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("div");
        dom.setAttribute(el1,"class","message-item");
        dom.setAttribute(el1,"id","m1");
        var el2 = dom.createTextNode("\n                            ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","message-inner");
        var el3 = dom.createTextNode("\n                                ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","message-head");
        var el4 = dom.createTextNode("\n                                    ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("div");
        dom.setAttribute(el4,"class","user-detail");
        var el5 = dom.createTextNode("\n                                        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("div");
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("div");
        dom.setAttribute(el6,"class","avatar pull-left");
        var el7 = dom.createTextNode("\n                                                ");
        dom.appendChild(el6, el7);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("div");
        dom.setAttribute(el6,"class","asker-meta");
        var el7 = dom.createTextNode("\n                                                ");
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("span");
        dom.setAttribute(el7,"class","qa-message-what");
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n                                                ");
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("span");
        dom.setAttribute(el7,"class","qa-message-when");
        var el8 = dom.createTextNode("\n                                                    ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("span");
        dom.setAttribute(el8,"class","qa-message-when-data pull-right");
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","qa-message-content");
        var el4 = dom.createTextNode("\n                                    ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createComment("");
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph0 = dom.createMorphAt(dom.childAt(element11, [1, 1, 1]),3,3);
      var morph1 = dom.createMorphAt(element13,1,1);
      var morph2 = dom.createMorphAt(dom.childAt(element12, [5, 1, 3, 1]),1,1);
      ...
      element(env, element14, context, "action", ["loadMorePosts"], {});
      block(env, morph2, context, "each", [get(env, context, "controller.tweets")], {"keyword": "tweet"}, child2, null);
      return fragment;
    }
  };
}()));
...
Ember.TEMPLATES['portfolio'] =  Ember.HTMLBars.template((function() {
    ...
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          element(env, element12, context, "action", ["cancelState"], {});
          element(env, element13, context, "action", ["saveEdits"], {});
          return fragment;
        }
      };
    }());
    var child1 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph0 = dom.createMorphAt(fragment,3,3,contextualElement);
          dom.insertBoundary(fragment, null);
          element(env, element11, context, "action", ["editState"], {});
    ...
    var child0 = (function() {
      ...
      var child2 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            element(env, element6, context, "action", ["cancelDelete", get(env, context, "project")], {});
            element(env, element7, context, "action", ["confirmDelete", get(env, context, "project")], {});
            return fragment;
          }
        };
      }());
      var child3 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            var element5 = dom.childAt(fragment, [1]);
            element(env, element5, context, "action", ["deleteModel", get(env, context, "project")], {});
            return fragment;
          }
        };
      }());
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var element8 = dom.childAt(fragment, [1]);
          var element9 = dom.childAt(element8, [1, 1, 1]);
          var element10 = dom.childAt(element8, [3]);
          var morph0 = dom.createMorphAt(dom.childAt(element10, [3]),0,0);
          var morph1 = dom.createMorphAt(dom.childAt(element10, [7]),0,0);
          var morph2 = dom.createMorphAt(dom.childAt(element10, [11]),0,0);
          var morph3 = dom.createMorphAt(element10,13,13);
          var morph4 = dom.createMorphAt(element10,14,14);
          var morph5 = dom.createMorphAt(element10,18,18);
          element(env, element9, context, "bind-attr", [], {"src": get(env, context, "project.image")});
          inline(env, morph0, context, "input", [], {"class": "form-control", "type": "text", "value": get(env, context, "project.name")});
          inline(env, morph1, context, "input", [], {"class": "form-control", "type": "text", "value": get(env, context, "project.subheading")});
          inline(env, morph2, context, "textarea", [], {"class": "form-control", "value": get(env, context, "project.description"), "rows": "10"});
          block(env, morph3, context, "if", [get(env, context, "project.project_link")], {}, child0, null);
          block(env, morph4, context, "if", [get(env, context, "project.code_link")], {}, child1, null);
          block(env, morph5, context, "if", [get(env, context, "project.enableDelete")], {}, child2, child3);
          return fragment;
        }
      };
    }());
    var child1 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph4 = dom.createMorphAt(element4,8,8);
          element(env, element3, context, "bind-attr", [], {"src": get(env, context, "project.image")});
          content(env, morph0, context, "project.name");
          content(env, morph1, context, "project.subheading");
          content(env, morph2, context, "project.description");
          block(env, morph3, context, "if", [get(env, context, "project.code_link")], {}, child0, null);
  ...
  return {
    ...
    build: function build(dom) {
      ...
      var el2 = dom.createTextNode("    ");
      dom.appendChild(el1, el2);
      var el2 = dom.createComment("<div class=\"row text-center\">\n        <div class=\"col-lg-12\">\n            <ul class=\"pagination\">\n                <li>\n                    <a href=\"#\">&laquo;</a>\n                </li>\n                <li class=\"active\">\n                    <a href=\"#\">1</a>\n                </li>\n                <li>\n                    <a href=\"#\">2</a>\n                </li>\n                <li>\n                    <a href=\"#\">3</a>\n                </li>\n                <li>\n                    <a href=\"#\">4</a>\n                </li>\n                <li>\n                    <a href=\"#\">5</a>\n                </li>\n                <li>\n                    <a href=\"#\">&raquo;</a>\n                </li>\n            </ul>\n        </div>\n    </div>");
      dom.appendChild(el1, el2);
      var el2 = dom.createTextNode("\n");
      dom.appendChild(el1, el2);
      dom.appendChild(el0, el1);
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph0 = dom.createMorphAt(dom.childAt(element14, [1, 1, 1]),3,3);
