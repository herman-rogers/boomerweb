...
Ember.TEMPLATES['blog'] =  Ember.HTMLBars.template((function() {
  var child0 = (function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element3, context, "action", ["editState"], {});
        return fragment;
      }
    };
  }());
  var child1 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element2, context, "action", ["savePostEdits"], {});
        return fragment;
      }
    };
  }());
    ...
    var child1 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          inline(env, morph2, context, "date-format", [get(env, context, "post.created_at")], {});
          element(env, element0, context, "bind-attr", [], {"src": get(env, context, "post.image")});
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph1 = dom.createMorphAt(element5,4,4);
      var morph2 = dom.createMorphAt(dom.childAt(element4, [3, 1]),1,1);
      block(env, morph0, context, "if", [get(env, context, "loggedIn")], {}, child0, null);
      block(env, morph1, context, "if", [get(env, context, "isEditing")], {}, child1, null);
      block(env, morph2, context, "each", [get(env, context, "model")], {"keyword": "post"}, child2, null);
      return fragment;
    }
  };
}()));
...
Ember.TEMPLATES['index'] =  Ember.HTMLBars.template((function() {
  ...
  var child1 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element3, context, "action", ["showModalLogin"], {});
        return fragment;
      }
    };
  }());
  ...
  var child5 = (function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el6 = dom.createTextNode("Enter Your Details");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "input", [], {"type": "text", "class": "form-control", "id": "uLogin", "placeholder": "Login", "value": get(env, context, "email")});
        inline(env, morph1, context, "input", [], {"type": "password", "class": "form-control", "id": "uPassword", "placeholder": "Password", "value": get(env, context, "password")});
  ...
  return {
    ...
    build: function build(dom) {
      ...
      dom.setAttribute(el9,"class","btn btn-social btn-outline");
      var el10 = dom.createElement("i");
      dom.setAttribute(el10,"class","fa fa-fw fa-twitter fa-lg");
      ...
      dom.setAttribute(el9,"class","btn btn-social btn-outline");
      var el10 = dom.createElement("i");
      dom.setAttribute(el10,"class","fa fa-fw fa-linkedin fa-lg");
      dom.appendChild(el9, el10);
      dom.appendChild(el8, el9);
      var el9 = dom.createTextNode("\n                            ");
      dom.appendChild(el8, el9);
      ...
      dom.setAttribute(el9,"class","btn btn-social btn-outline");
      var el10 = dom.createElement("i");
      dom.setAttribute(el10,"class","fa fa-fw fa-github fa-lg");
      dom.appendChild(el9, el10);
      dom.appendChild(el8, el9);
      var el9 = dom.createTextNode("\n                            ");
      dom.appendChild(el8, el9);
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element5 = dom.childAt(fragment, [0, 1, 3]);
      ...
      var morph3 = dom.createMorphAt(dom.childAt(element6, [5]),0,0);
...
Ember.TEMPLATES['portfolio'] =  Ember.HTMLBars.template((function() {
    ...
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el1 = dom.createElement("a");
          dom.setAttribute(el1,"class","btn btn-primary");
          var el2 = dom.createTextNode("View Project ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
          dom.setAttribute(el2,"class","glyphicon glyphicon-chevron-right");
          dom.appendChild(el1, el2);
        ...
        render: function render(context, env, contextualElement) {
          ...
          attribute(env, attrMorph0, element1, "href", get(env, context, "project.project_link"));
          return fragment;
        }
      };
    }());
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el1 = dom.createElement("a");
          dom.setAttribute(el1,"class","btn btn-primary");
          var el2 = dom.createTextNode("View Code ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("span");
        ...
        render: function render(context, env, contextualElement) {
          ...
          attribute(env, attrMorph0, element0, "href", get(env, context, "project.code_link"));
          return fragment;
        }
      };
    }());
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      block(env, morph0, context, "each", [get(env, context, "model")], {"keyword": "project"}, child0, null);
      return fragment;
    }
  };
}()));